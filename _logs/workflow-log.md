...
| 2026-05-27 | Source inventory + pilot 002/003 case cards | 0_raw/metadata / 1_digest | 0_raw/metadata/source-inventory.md; 0_raw/metadata/source-index.md; 1_digest/case_cards/CC-COURT-ZHANG-32-ILLEGAL-MINING-YANCHENG.md; 1_digest/case_cards/CC-COURT-CHEN-GUJK-CULTURAL-RELIC.md | pilot/source-inventory-select-002-003 分支；扫描全部 0_raw 案例材料（20个文件），建立 source-inventory.md；选定两个对照型 pilot 案例：002 张某山等32人非法采矿案（刑附民/前科认定故意/1倍赔偿/基数剔除直接损失）和 003 贵州江口陈某平案（纯民事/个人行为人劝阻后仍故意/文物+自然遗产/固定金额25000元）；生成 case card；digest card validator 和 layer boundary validator 均通过；更新 source-index.md；未生成 final report、未生成横向结论、未开发 MCP 功能；case card 内容均有案例文本依据。 |
